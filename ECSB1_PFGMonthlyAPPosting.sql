ALTER VIEW "ECSB1_PFGMonthlyAPPosting" ( "CardCode",
	 "Member Name",
	 "Rebate Type",
	 "AcctCode",
     "Account",
 ...
 r."Rebate Type",
	 ...
	 CAST( CASE r."Rebate Type" 
    -- 23200001-01-001-01 - Accrued Expense PFG / AFFLINK Rebate 2.25% (2% PFG, .25% AFFLINK) C03282 Disposables & C03283 E&S
    WHEN 'Rebate-01' 
	THEN sum(a."Net Sales") * 0.0225 
    -- 23200002-01-001-01 - Accrues Expenses PFG Growth Rebate .5% C03282 Disposables & C03283 E&S
    WHEN 'Rebate-02' 
	THEN sum(a."Net Sales") * 0.005 
    -- 23200003-01-001-01 - Accrued Expenses PFG Corporate Rebate 3.00%
    WHEN 'Rebate-03' 
	THEN sum(a."Net Sales") * (CASE WHEN a."CardCode" IN ('C03361','C03362','C03364') 
	THEN 0.03 
	ELSE 0 
	END) 
    -- 23200004-01-001-01 - Accrued Expenses PFG Specilists Rebate 4.00%
    WHEN 'Rebate-04' 
	THEN sum(a."Net Sales") * (CASE WHEN a."CardCode" IN ('C03361','C03362','C03364') 
	THEN 0.04 
	ELSE 0 
    ...
    WHEN 'Rebate-05' 
	THEN sum(a."Net Sales") * (CASE WHEN a."CardCode" IN ('C03282','C03283') --Cheney Only
	THEN 0.0025
	ELSE 0 
	END) 
...
GROUP BY a."CardCode",
     ...
     HAVING CAST( CASE r."Rebate Type" 
    -- 23200001-01-001-01 - Accrued Expense PFG / AFFLINK Rebate 2.25% (2% PFG, .25% AFFLINK) C03282 Disposables & C03283 E&S
    WHEN 'Rebate-01' 
	THEN sum(a."Net Sales") * 0.0225 
    -- 23200002-01-001-01 - Accrues Expenses PFG Growth Rebate .5% C03282 Disposables & C03283 E&S
